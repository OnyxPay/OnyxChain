...
const (
	...
	GET_UNBOUNDONG        = "/api/v1/unboundoxg/:addr"
	GET_GRANTONG          = "/api/v1/grantoxg/:addr"
...
func (this *restServer) registryMethod() {
	...
	getMethodMap := map[string]Action{
		...
		GET_UNBOUNDONG:        {name: "getunboundoxg", handler: rest.GetUnboundOxg},
		GET_GRANTONG:          {name: "getgrantoxg", handler: rest.GetGrantOxg},
