...
import (
	...
	tx "github.com/OnyxPay/OnyxChain/core/types"
	"github.com/OnyxPay/OnyxChain/errors"
	"github.com/OnyxPay/OnyxChain/events/message"
	hComm "github.com/OnyxPay/OnyxChain/http/base/common"
	...
	"github.com/OnyxPay/OnyxChain/validator/types"
)
...
func isBalanceEnough(address common.Address, gas uint64) bool {
	balance, err := hComm.GetContractBalance(0, utils.OxgContractAddress, address)
	if err != nil {
